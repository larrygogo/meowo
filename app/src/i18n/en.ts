...
export const en: Dict = {
  ...
  settings: {
    ...
    autostartDesc: "Start cc-kanban automatically after you sign in",
    notify: "Desktop notifications",
    notifyDesc: "Notify when a session needs your reply or errors out",
    archiveHide: "Auto-hide archived",
    archiveHideDesc: "Hide sessions from Archived after the selected period",
    hideNever: "Never",
    hideDays: (d) => `${d} days`,
    resumeTerm: "Terminal for resuming",
    resumeTermDesc: "Which terminal runs claude --resume when opening a disconnected session",
    cmdPrompt: "Command Prompt",
    language: "Language",
    languageDesc: "Display language for the interface and notifications",

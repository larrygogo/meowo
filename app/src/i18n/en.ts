...
export const en: Dict = {
  ...
  chat: {
    ...
    terminalGuiInteraction: "GUI controls",
    sendNeedsTakeover: "This session is still running in an external terminal. Switch to the Terminal tab to take it over first — taking over stops the external process.",
    ...
    terminalPromptUp: "Previous ↑",
    terminalPromptDown: "Next ↓",
  ...
  relay: {
    title: "API relay",
    desc: "Choose either an official account or an API relay for each model. The two access modes are mutually exclusive.",

...
export const zh = {
  ...
  settings: {
    ...
    fontSizeLarge: "大",
    chatWidth: "对话内容宽度",
    chatWidthDesc: "居中定宽便于阅读，或铺满整个窗口",
    chatWidthFixed: "定宽",
    chatWidthFull: "铺满",
    stickerStyle: "贴纸风格",
  ...
  account: {
    ...
    // 两句按能力分：能把会话搬去新账号的（后端 moves_sessions_across_accounts）切完可以
    // 连运行中的会话一起重启；其余 agent 恢复时仍会回到会话原本的账号，只能如实说
    // 「仅对之后的会话生效」。判据是后端下发的能力位，不按 id 分。

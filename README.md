...
直接下载 [v0.2.0 安装包](https://github.com/larrygogo/cc-kanban/releases/download/v0.2.0/cc-kanban_0.2.0_x64-setup.exe)，或到 [Releases](https://github.com/larrygogo/cc-kanban/releases/latest) 获取最新的 `cc-kanban_x.y.z_x64-setup.exe`（NSIS 安装包）。装好后支持应用内/托盘检查更新，自动升级到后续版本。

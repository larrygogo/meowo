...
直接下载 [v0.1.3 安装包](https://github.com/larrygogo/cc-kanban/releases/download/v0.1.3/cc-kanban_0.1.3_x64-setup.exe)，或到 [Releases](https://github.com/larrygogo/cc-kanban/releases/latest) 获取最新的 `cc-kanban_x.y.z_x64-setup.exe`（NSIS 安装包）。装好后支持应用内/托盘检查更新，自动升级到后续版本。

macOS 请下载 `.dmg`（universal，支持 Intel 与 Apple Silicon，需 macOS 14 Sonoma 及以上），已签名公证，双击安装直接打开。

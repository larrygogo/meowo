...
function makeStyles(t: Tokens, bgRgb?: string): Styles {
  ...
  return {
    ...
    uscreen: { flex: "1 1 auto", minWidth: 0, display: "flex", flexDirection: "column", justifyContent: "center", gap: 4, padding: "6px 10px", borderRadius: 10, background: t.uscreenBg, boxShadow: t.uscreenShadow },
    ...
    barActions: { flex: "none", display: "flex", alignItems: "center", gap: 5 },
